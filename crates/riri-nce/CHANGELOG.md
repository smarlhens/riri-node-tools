...
## [0.2.0](https://github.com/smarlhens/riri-node-tools/compare/riri-nce-v0.1.5...riri-nce-v0.2.0) (2026-08-19)
...
* **nce,lockfile:** open engines for any package manager ([b2dc613](https://github.com/smarlhens/riri-node-tools/commit/b2dc613389261339f33ebcd8261064edfb1e5d3f))
...
* **nce:** make engine application pure ([a6f046a](https://github.com/smarlhens/riri-node-tools/commit/a6f046af1ac2b91f96fd235c4be4f3525cd11c58))
* **nce:** make refresh opt-in for library consumers ([beaaf83](https://github.com/smarlhens/riri-node-tools/commit/beaaf83cb42cc429771a9e8f2ab09dcbdb370f47))


### Bug Fixes

* **semver-range:** match prereleases below an upper-bound-only range ([f140d07](https://github.com/smarlhens/riri-node-tools/commit/f140d074c78116b93c65f380fb9e15acd0dcc2ca))


### Performance Improvements

* **nce:** read package json once ([ad2d212](https://github.com/smarlhens/riri-node-tools/commit/ad2d21261eecabd2056d825207e1737fe06e5037))
