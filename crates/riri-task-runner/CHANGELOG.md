...
## [0.1.1](https://github.com/smarlhens/riri-node-tools/compare/riri-task-runner-v0.1.0...riri-task-runner-v0.1.1) (2026-06-23)


### Features

* **riri-task-runner:** implement task runner with renderer modes ([919ceea](https://github.com/smarlhens/riri-node-tools/commit/919ceeae4afb8009142518d01f2c1a6d5ce096bb))
